...
test('为 WSL Bridge 生成文件系统路径和 Lightroom Windows 路径', () => {
  ...
  assert.strictEqual(paths.fsRoot, '/mnt/c/Users/lvchanghong/.tonepilot-lightroom-bridge')
  assert.strictEqual(paths.lightroomRoot, 'C:\\Users\\lvchanghong\\.tonepilot-lightroom-bridge')
  assert.strictEqual(paths.fs('results', 'session-1.jpg'), '/mnt/c/Users/lvchanghong/.tonepilot-lightroom-bridge/results/session-1.jpg')
