package com.tonepilot.application.runtime;
...
public class RuntimeIngestService {
    ...
    @Autowired
    private RuntimeIngestRepository repository;

    public RuntimeDeviceRegistrationResponse registerDevice(RuntimeDeviceRegistrationRequest request) {
        return repository.registerDevice(request);
    }

    public RuntimeEventRecord recordEvent(RuntimeEventRequest request) {
