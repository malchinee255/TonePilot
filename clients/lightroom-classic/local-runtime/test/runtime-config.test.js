...
test('不再接受 rule 作为运行时模型厂商', () => {
  const providerConfig = providerRuntimeConfig({ provider: 'rule' }, 'rule')

  assert.strictEqual(providerConfig.provider, 'qwen2')
})
